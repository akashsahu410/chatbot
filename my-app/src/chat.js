...
render() {
    return (
      <div>
        <div className="chathistory" id="chat" style={{height:"81vh",overflowY:"scroll"}}>
        <ul className="collection" id="scroll">
          
            {/* <img src="//robohash.org/107378?set=set2&bgset=bg2&size=70x70" alt="107378" className="circle" /> */}
  {this.state.message.map(x=>{ return x.name === "Robot" ? 
      (<li className="collection-item avatar" style={{clear:"right",width:"40%",backgroundColor:"#ece5dd",paddingLeft:25,paddingRight:25}}>
    ...
    : 
    (<li className="collection-item avatar" style={{float:"right",width:"40%",backgroundColor:"#dcf8c6",paddingRight:25,paddingLeft:25}}>
            ...
            <form className="container">
              <div className="row">
                <div className="input-field col s10" target="#focus">
                  ...
                  <input type="text" placeholder="Type your message" onChange={this.onChange} autoFocus name="input" value={this.state.input}/>
                ...
                <div className="input-field col s2">
                  <button type="submit" data-scroll-to="#id1"
        data-scroll-focus="#id2"
        data-scroll-speed="700"
        data-scroll-offset="200" className="waves-effect waves-light btn-floating btn-large" onClick={this.sendData}>
